                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="559 999 999" data-mask="559 999 999" class="form-control" id="telefono" name="phone" required>
                                <span class="font-13 text-muted">Ejemplo: 558 547 848</span>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
