                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>948574256</td>
                                    <td>
                                        <button class="btn btn-icon waves-effect waves-light btn-success m-b-5" data-toggle="modal" data-target="#con-editar-modal" title="Editar contacto">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                        <button class="btn btn-icon waves-effect waves-light btn-info m-b-5" title="Recuperar contacto">
